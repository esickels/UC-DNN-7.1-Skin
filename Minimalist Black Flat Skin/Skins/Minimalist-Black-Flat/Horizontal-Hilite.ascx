  ...
  <tr>
    ...
    <td class="BoxM" valign="top">
						<table align="center" class="FullHeight StandardWidth" border="0" cellspacing="0" cellpadding="0">
						  ...
						  <tr>
							<td class="ImagePane02 Height1px" colspan="2" valign="top" id="ImagePane02" runat="server" visible="false"></td>
						  </tr>
						  <tr>
						  ...
						  <tr>
							<td class="CopyrightRow" colspan="2">
								<table width="100%" cellpadding="0" cellspacing="0"><tr>
									...
									<span class="FOOTER_objects"><img src="<%=skinpath%>dummy.gif" alt="" height="1" width="1" class="Invisible" /><img src="<%=skinpath%>dummy.gif" alt="" height="1" width="1" class="Invisible" /><img src="<%=skinpath%>ico-login-over.gif" height="1" width="1" alt="" class="Invisible" /><img src="<%=skinpath%>ico-register-over.gif" alt="" height="1" width="1" class="Invisible" /><img src="<%=skinpath%>nav5-selected.gif" alt="" height="1" width="1" class="Invisible" /><img src="<%=skinpath%>subnav5-active-l.gif" alt="" height="1" width="1" class="Invisible" /><img src="<%=skinpath%>subnav5-active.gif" alt="" height="1" width="1" class="Invisible" /><img src="<%=skinpath%>subnav5-active-r.gif" alt="" height="1" width="1" class="Invisible" /><br /><dnn:COPYRIGHT runat="server" id="dnnCOPYRIGHT" CssClass="FOOTER_objects" /></span>
									</td>
								</tr></table>
