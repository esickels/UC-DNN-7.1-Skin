  ...
  <tr>
    ...
    <td class="BoxM" valign="top">
						<table align="center" class="FullHeight StandardWidth" border="0" cellspacing="0" cellpadding="0">
						  ...
						  <tr>
							<td class="FlashTDV Height1px" colspan="2" valign="top">
						  ...
						  <tr>
                            <td class="PanelTD PanelWidth" valign="top"><DIV class="PanelMid PanelBG"><DIV class="PanelGrad"><DIV class="PanelL"><DIV class="PanelR"><DIV class="PanelT"><DIV class="PanelB"><DIV class="PanelBL"><DIV class="PanelBR"><DIV class="PanelTL"><DIV class="PanelTR">
                                            <IMG src="<%=skinpath%>panel6-border.gif" height="1" width="212"><br /><dnn:SOLPARTMENU
                                                runat="server"
                                                id="dnnSOLPARTMENU"
                                                menualignment="left"
                                                separatecss="true"
                                                ...
                                                /><IMG src="<%=skinpath%>dummy.gif" height="1" width="194"><br /><br />
						  ...
						  <tr>
							<td class="CopyrightRow" colspan="2">
								<table width="100%" cellpadding="0" cellspacing="0"><tr>
									...
									<span class="FOOTER_objects"><img src="<%=skinpath%>dummy.gif" alt="" height="1" width="1" class="Invisible" /><img src="<%=skinpath%>dummy.gif" alt="" height="1" width="1" class="Invisible" /><img src="<%=skinpath%>ico-login-over.gif" height="1" width="1" alt="" class="Invisible" /><img src="<%=skinpath%>ico-register-over.gif" alt="" height="1" width="1" class="Invisible" /><img src="<%=skinpath%>nav6-selected.gif" alt="" height="1" width="1" class="Invisible" /><br /><dnn:COPYRIGHT runat="server" id="dnnCOPYRIGHT" CssClass="FOOTER_objects" /></span>
									</td>
								</tr></table>
